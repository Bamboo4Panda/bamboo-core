...
RESOURCES += src/qt/bamboo.qrc src/qt/bamboo_locale.qrc

TRANSLATIONS += src/qt/locale/bamboo_bg.ts \
                src/qt/locale/bamboo_de.ts \
                src/qt/locale/bamboo_en.ts \
                src/qt/locale/bamboo_es.ts \
                src/qt/locale/bamboo_fi.ts \
                src/qt/locale/bamboo_fr.ts \
                src/qt/locale/bamboo_it.ts \
                src/qt/locale/bamboo_ja.ts \
                src/qt/locale/bamboo_pl.ts \
                src/qt/locale/bamboo_pt.ts \
                src/qt/locale/bamboo_ru.ts \
                src/qt/locale/bamboo_sk.ts \
                src/qt/locale/bamboo_sv.ts \
                src/qt/locale/bamboo_vi.ts \
                src/qt/locale/bamboo_zh_CN.ts \
                src/qt/locale/bamboo_zh_TW.ts
