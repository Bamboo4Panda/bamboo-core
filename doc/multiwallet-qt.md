...
In order to support loading of multiple wallets in bamboo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bamboo.cpp.
...
Changes to bamboo.cpp
----------------------
bamboo.cpp is the entry point into bamboo-qt, and as such, will require some minor modifications to provide hooks for
