...
// Copyright (c) 2015-2017 The Bamboo Core developers
 ...
 * Bamboo system. There are three: the main network on which people trade goods
...
public:
    ...
    int DGW_POS_BLOCK() const { return nPOSDGWBlock; }
