...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bamboo features */
        {"bamboo", "masternode", &masternode, true, true, false},
        {"bamboo", "listmasternodes", &listmasternodes, true, true, false},
        {"bamboo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bamboo", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bamboo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bamboo", "masternodedebug", &masternodedebug, true, true, false},
        {"bamboo", "startmasternode", &startmasternode, true, true, false},
        {"bamboo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bamboo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bamboo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bamboo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bamboo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bamboo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bamboo", "mnbudget", &mnbudget, true, true, false},
        {"bamboo", "preparebudget", &preparebudget, true, true, false},
        {"bamboo", "submitbudget", &submitbudget, true, true, false},
        {"bamboo", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bamboo", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bamboo", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bamboo", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bamboo", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bamboo", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bamboo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bamboo", "checkbudgets", &checkbudgets, true, true, false},
        {"bamboo", "mnsync", &mnsync, true, true, false},
        {"bamboo", "spork", &spork, true, true, false},
        {"bamboo", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bamboo", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bambood, or the -server option to bamboo-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bamboo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8050/\n";
}
