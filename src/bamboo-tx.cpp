...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bamboo Core bamboo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bamboo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bamboo transaction") + "\n" +
                               "  bamboo-tx [options] -create [commands]   " + _("Create hex-encoded bamboo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bamboo transaction
