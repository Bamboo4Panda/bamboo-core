/* src/config/bamboo-config.h.  Generated from bamboo-config.h.in by configure.  */
/* src/config/bamboo-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.bamboo.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bamboo Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bamboo Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bamboo"
