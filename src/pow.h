...
unsigned int Get2BlocksNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader* pblock);unsigned int GetDGWNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader* pblock, int64_t targetSpacing, uint256 workLimit);
