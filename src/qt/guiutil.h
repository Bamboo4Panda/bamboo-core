...
/** Utility functions used by the Bamboo Qt UI.
 */
namespace GUIUtil
{
...
// Render Bamboo addresses in monospace font
...
// Parse "bamboo:" URI into recipient object, return true on successful parsing
