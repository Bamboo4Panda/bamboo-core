...
spinnerFrame(0)
{
	...
	QString windowTitle = tr("Bamboo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
	...
	sendCoinsAction->setStatusTip(tr("Send coins to a BOO address"));
	...
	receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bamboo: URIs)"));
	...
	privacyAction->setStatusTip(tr("Privacy Actions for zBOO"));
	...
	aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bamboo Core"), this);
	aboutAction->setStatusTip(tr("Show information about Bamboo Core"));
	...
	optionsAction->setStatusTip(tr("Modify configuration options for BOO"));
	...
	signMessageAction->setStatusTip(tr("Sign messages with your BOO addresses to prove you own them"));
	verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
	verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BOO addresses"));
	...
	openAction->setStatusTip(tr("Open a BOO: URI or payment request"));
	openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
	openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

	showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
	showHelpMessageAction->setMenuRole(QAction::NoRole);
	showHelpMessageAction->setStatusTip(tr("Show the Bamboo Core help message to get a list with possible BOO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
	...
	QString toolTip = tr("Bamboo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BOO network", "", count));
}
...
{
	QString strTitle = tr("Bamboo Core"); // default title
