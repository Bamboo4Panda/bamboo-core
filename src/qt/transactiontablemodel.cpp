...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Bamboo to zBamboo");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zBamboo");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Bamboo from zBamboo");
    case TransactionRecord::ZerocoinSpend_Change_zBamboo:
        return tr("Minted Change as zBamboo from zBamboo Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zBamboo to Bamboo");
