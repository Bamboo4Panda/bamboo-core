Contributing to Bamboo Core
============================

The Bamboo Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bamboo Core project, and is not to be
confused with overall Bamboo Network Protocol consensus changes.

Whether a pull request is merged into Bamboo Core rests with the project merge
...
Patches that change Bamboo consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bamboo consensus, it must have been
...
The project leader is the release manager for each Bamboo Core release.
